  ...
  return (
    <div className="main-container-interview-questions">
      ...
      <div className="question-answer">
        ...
        <p>
          Java is a class-based, object-oriented programming language with
          minimal implementation dependencies.A general-purpose programming
          language, Java allows programmers to write once and run anywhere
          (WORA), meaning compiled Java code can execute on all Java-supported
          platforms without recompilation. Java applications are usually
          compiled to bytecode that works on any JVM, regardless of computer
          architecture.
        </p>
        ...
        <p>
          ...
          developed by James Gosling and his team at Sun Microsystems in the
          early 1990s.
        </p>
        <ul>
          <li>
            <p>
              ...
              Microsystems develop a programming language called
              &quot;Oak,&quot; intended for consumer electronics. In 1995, Oak
              is officially released as Java 1.0, with a focus on platform
              independence.
            </p>
          </li>
          <li>
            <p>
              ...
              featuring significant enhancements, including the Swing GUI
              toolkit and the Collections Framework.
            </p>
          </li>
          <li>
            <p>
              <strong>Early 2000s:</strong> Java splits into three platforms:
              J2SE (Standard Edition) for desktop, J2EE (Enterprise Edition) for
          ...
          <li>
            <p>
              <strong>2006:</strong> Sun Microsystems open-sources Java under
              the GNU General Public License (GPL), launching the OpenJDK
              initiative to encourage community involvement.
            </p>
          </li>
          <li>
            <p>
              <strong>2010:</strong> Oracle Corporation acquires Sun
              Microsystems, becoming the steward of Java.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              model, with a new version every six months starting from Java SE
              9. Notable releases include Java 9 (module system), Java 11
              (Long-Term Support), and subsequent updates with new features and
              improvements.
            </p>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <p>
              OOP is an abbreviation for Object-Oriented Programming language.
              OOP denotes that everything in Java is considered an object. Java
              is not compiled into a platform-specific machine; rather, it is
              compiled into platform-independent bytecode. The Virtual Machine
              that operates the platform interprets this code.
            </p>
          </li>
        </ul>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                JRE refers to a runtime environment in which Java bytecode can
                be executed.
              </td>
              <td>
        ...
        <br />
        <p>
          <img src={images.jdk} alt="" className="img-cls" />
        </p>
        <h4 id="6-how-does-the-java-program-get-executed">
          6. How does the Java program get executed?
        </h4>
        <p>
          The execution of a Java program involves several steps, from writing
          the source code to the actual execution on the Java Virtual Machine
          (JVM).
        </p>
        <p>
          <strong>Step 1: Write Java Source Code</strong>
        </p>
        <p>
        ...
        <p>
          <strong>Step 2: Compile Java Source Code:</strong>
        </p>
        <p>
          The javac compiler is used to compile the source code
          <strong>(HelloWorld.java)</strong> into bytecode. Bytecode is stored
          in a file with the .class extension{" "}
          <strong>(HelloWorld.class)</strong>.
        </p>
        <p>
          <strong>Step 3: Execute on Java Virtual Machine (JVM):</strong>
        </p>
        <p>
          The compiled bytecode (HelloWorld.class) is executed on the Java
          Virtual Machine. The JVM interprets the bytecode and translates it
          into machine code specific to the underlying hardware.The result is
          the execution of the Java program, and the output is displayed on the
          console.
        </p>
        <p>
          <img src={images.acrchitecture} alt="" className="img-cls" />
        </p>
        ...
        <p>
          Java source code is initially compiled by the Java Compiler (javac)
          into an intermediate form called bytecode. Bytecode is a
          platform-independent representation of the program, and it is not
          specific to any particular hardware or operating system.
        </p>
        <p>
        ...
        <p>
          ...
          provides a runtime environment for Java programs.The JVM translates
          the bytecode into machine code specific to the host machine using a
        ...
        <p>
          Java is not 100% Object-oriented because it makes use of eight
        ...
        {/* <pre>
          <code>
            class HelloWorld&#123; <br></br>
                public static void main(String args[]) &#123; <br></br>
                System.out.println(&quot;Hello World&quot;); <br></br>&#125;<br></br> &#125;
          </code>
        </pre> */}
    ...
    public static void main(String args[]) {
        ...
        <p>
          <img src={images.Helloworld} alt="" className="img-cls" />
        </p>
        <h4 id="10-define-the-jit-compiler-in-java">
          10. Define the JIT compiler in Java?
        </h4>
        <p>
          Just In Time Compiler is the component of JRE, which is used to
          compile the bytecodes of the particular method into the native machine
          code. This compiled code of the method is directly called by JVM
        ...
        <p>
          In Java, variables are containers that store data values. Each
          variable must be declared with a data type, and it can hold a specific
          type of data.
        </p>
        ...
        <pre>
          {/* <code>
            // Integer variable int age; // Double variable double salary; //
            String variable String name; // Boolean variable boolean isStudent;
          </code> */}
          <pre className="code-block">
            <code>
              {`// Integer variable
...
boolean isStudent;`}
        ...
        {/* <pre>
          <code>
            // Declare and initialize int numberOfBooks = 10; // Later
            initialization double pi; pi = 3.14159; // Initializing with a
...
String greeting = "Hello, World!";`}
        ...
        {/* <pre>
          <code>
            void exampleMethod() &#123; int x; // Local variable x = 5; //
            Initialization // ... &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    // ...
        ...
        <p>
          <strong>Instance Variables (Object Variables):</strong>
        </p>
        <p>
        ...
        {/* <pre>
          <code>
            public class MyClass &#123; int age; // Instance variable String
        ...
        <p>
          <strong>Class Variables (Static Variables):</strong>
        </p>
        <p>
          Declared with the static keyword. Shared among all instances of a
          class.
        </p>
        <h6 id="example-4">Example:</h6>
        {/* <pre>
          <code>
            public class MyClass &#123; static int count; // Class variable
            &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    static int count;// Class variable
        ...
        {/* <pre>
          <code>
            class Example&#123; int num=30;//instance variable static char
            name=&quot;Thamizh&quot;;//static variable void method()&#123; int
            n=90;//local variable &#125; &#125;//end of class
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
    ...
    void method() {
        ...
        <p>
          ...
          directly operate upon the machine instructions.They are not objects
          and do not have methods.There are eight primitive data types in Java,
          and they are categorized into four groups: integer, floating-point,
        ...
        <p>
          byte: <strong>Size:</strong> 8 bits <strong>Range:</strong> -128 to
          127
        </p>
        <p>
          short: <strong>Size:</strong> 16 bits <strong>Range:</strong> -32,768
          to 32,767
        </p>
        <p>
        ...
        {/* <pre>
          <code>
            byte age = 25; short distance = 10000; int population = 2000000;
            long totalStars = 123456789012345L; // Note the &#39;L&#39; at the
            end to denote a long literal
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
long totalStars = 123456789012345L; // Note the 'L' at the end to denote a long literal`}
          </code>
        </pre>

        <p>
          <strong>Floating-Point Data Types:</strong>
        </p>
        <p>
        ...
        {/* <pre>
          <code>
            float salary = 50000.50f; // Note the &#39;f&#39; at the end to
            denote a float literal double pi = 3.14159; // The &#39;d&#39; at
            the end is optional for double literals
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
            {`float salary = 50000.50f;  // Note the 'f' at the end to denote a float literal
double pi = 3.14159;    // The 'd' at the end is optional for double literals`}
          </code>
        </pre>

        <p>
          <strong>Character Data Type:</strong>
        </p>
        <p>
        ...
        {/* <pre>
          <code>
            char grade = &#39;A&#39;; char symbol = &#39;\u20AC&#39;; // Unicode
        ...
        <pre className="code-block">
          <code>
            {`char grade = 'A';
char symbol = 'u20AC'; // Unicode representation of the Euro symbol`}
          </code>
        </pre>

        <p>
          <strong>Boolean Data Type:</strong>
        </p>
        <p>boolean: Represents true or false values.</p>
        <h6 id="example-3">Example</h6>
        {/* <pre>
          <code>boolean isJavaFun = true; boolean isFishTasty = false;</code>
        </pre> */}
        <pre className="code-block">
          <code>
...
boolean isFishTasty = false;`}
        ...
        <p>
          ...
          sometimes called &quot;objects&quot; because they refer to instances
          of classes or arrays.
        </p>
        <ul>
          <li>Classes</li>
          <li>Interfaces</li>
        ...
        <p>
          ...
          have both primitive and reference data types as their member
          variables.
        </p>
        <h6 id="example-9">Example:</h6>
        {/* <pre>
          <code>
            class Person &#123; String name; int age; &#125; // Creating an
            instance of the Person class Person person1 = new Person();
...
person1.age = 25;`}
        ...
        <p>
          ...
          classes that implement them.An interface reference can be used to
          refer to objects of classes that implement the interface.
        </p>
        <h6 id="example-10">Example:</h6>
        {/* <pre>
          <code>
            interface Drawable &#123; void draw(); &#125; class Circle
            implements Drawable &#123; public void draw() &#123;
            System.out.println(&quot;Drawing a circle&quot;); &#125; &#125; //
            Using an interface reference Drawable shape = new Circle();
            shape.draw();
          </code>
        </pre> */}
        <pre className="code-block">
...
shape.draw();`}
        ...
        <p>
          <strong>Enums:</strong> Enums (enumerations) in Java are reference
          data types that represent a fixed set of constants.
        </p>
        <h6 id="example-12">Example:</h6>
        {/* <pre>
          <code>
            enum Day &#123; SUNDAY, MONDAY, TUESDAY, WEDNESDAY, THURSDAY,
            FRIDAY, SATURDAY &#125; Day today = Day.MONDAY;
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
Day today = Day.MONDAY;`}
        ...
        {/* <pre>
          <code>
            class Car &#123; String model; int year; &#125; Car myCar = new
            Car(); myCar.model = &quot;Toyota&quot;; myCar.year = 2022;
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
myCar.year = 2022;`}
        ...
        <p>
          Typecasting in Java refers to the process of converting a variable
          from one data type to another.Java has two types of casting:
        </p>
        <ul>
        ...
        <p>
          <strong>Implicit (Automatic) Casting:</strong> Implicit casting
          happens automatically when a smaller data type is promoted to a larger
          data type. It is also known as widening or automatic type conversion.
          In implicit casting, there is no loss of data because the destination
          type can represent a larger range of values.
        </p>
        <h6 id="example-15">Example:</h6>
        {/* <pre>
          <code>
            int intValue = 42; long longValue = intValue; // Implicit casting
            from int to long
          </code>
        </pre> */}
        <pre className="code-block">
...
long longValue = intValue; // Implicit casting from int to long`}
        ...
        <p>
          <strong>Explicit (Manual) Casting:</strong> Explicit casting is
          required when a larger data type is demoted to a smaller data type. It
          is also known as narrowing or manual type conversion.Explicit casting
          requires the use of parentheses and can result in a loss of data if
          the value is too large to be represented by the destination type.
        </p>
        <h6 id="example-16">Example:</h6>
        {/* <pre>
          <code>
            double doubleValue = 123.456; int intValue = (int) doubleValue; //
...
int intValue = (int) doubleValue; // Explicit casting from double to int`}
        ...
        <p>
          ...
          Operands can be variables, literals, method calls, or expressions.
          Java supports a wide range of operators, which can be categorized into
          several types:
        </p>
        <ul>
        ...
        <p>
          The == operator is used to compare primitive data types and
          objects&#39; references.When used with primitive types (int, char,
          etc.), it checks if the values are equal.When used with objects, it
          checks whether the references point to the same memory location, not
          whether the contents of the objects are the same.
        </p>
...
System.out.println(a == b); // true`}
        ...
        {/* <pre>
          <code>
            String str1 = new String(&quot;Hello&quot;); String str2 = new
            String(&quot;Hello&quot;); System.out.println(str1 == str2); //
            false, as they are different objects in memory
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
System.out.println(str1 == str2); // false, as they are different objects in memory`}
        ...
        <p>
          ...
          classes override the .equals() method to compare the content of
        ...
        {/* <pre>
          <code>
            String str1 = new String(&quot;Hello&quot;); String str2 = new
            String(&quot;Hello&quot;); System.out.println(str1.equals(str2)); //
            true, as the contents are the same
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
System.out.println(str1.equals(str2)); // true, as the contents are the same`}
        ...
        <p>
          ...
          operator.It increments the value of the variable &#39;a&#39; before
          its current value is used in an expression.
        </p>
        <h6 id="example-17">Example:</h6>
        {/* <pre>
          <code>
            int a = 5; int b = ++a; // After this, &#39;a&#39; becomes 6, and
            &#39;b&#39; also becomes 6
          </code>
        </pre> */}
        <pre className="code-block">
...
// After this, 'a' becomes 6, and 'b' also becomes 6`}
        ...
        <p>
          ...
          original value (before incrementing) is used in the expression where
          the increment operation is applied.
        </p>
        <h6 id="example-18">Example:</h6>
        {/* <pre>
          <code>
            int a = 5; int b = a++; // After this, &#39;a&#39; becomes 6, but
            &#39;b&#39; becomes 5
          </code>
        </pre> */}
        <pre className="code-block">
...
// After this, 'a' becomes 6, but 'b' becomes 5`}
        ...
        <p>
          ...
          unique in that it takes three operands and is the only operator in
          Java that does so.The general syntax of the ternary operator is:
        </p>
        <p>
        ...
        {/* <pre>
          <code> int x = 5; int y = (x &gt; 0) ? 10 : 20;</code>
        </pre> */}
        <pre className="code-block">
          <code>
            {`int x = 5;
int y = (x > 0) ? 10 : 20;`}
        ...
        <h4 id="21-define-the-method-in-java">
          21. Define the method in Java?
        </h4>
        <p>
          ...
          primary building blocks of Java programs, allowing you to organize
          code, promote code reuse, and encapsulate functionality.
        </p>
        ...
        {/* <pre>
          <code>
            returnType methodName(parameter1Type parameter1Name, parameter2Type
            parameter2Name, ...) &#123; // Method body or code block // Perform
            tasks and computations // Optionally return a value using the
            &#39;return&#39; keyword &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    // Optionally return a value using the 'return' keyword
        ...
        {/* <pre>
          <code>
            public class MathOperations &#123; // Method without parameters and
            without a return value (void) public void sayHello() &#123;
            System.out.println(&quot;Hello, World!&quot;); &#125; // Method with
            parameters and a return value public int add(int num1, int num2)
            &#123; return num1 + num2; &#125; // Method without parameters and
            with a return value public double getRandomNumber() &#123; return
            Math.random(); &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    public double getRandomNumber() {
        ...
        <p>
          ...
          solving complex problems. Code can be reused through inheritance
          thereby reducing redundancy.Data and code are bound together by
        ...
        <p>
          ...
          (class).Encapsulation hides the internal details and provides
        ...
        {/* <pre>
          <code>
            // Define a simple class named &#39;Car&#39; public class Car &#123;
            // Attributes (data members) String make; String model; int year; //
            Constructor (initialize attributes when an object is created) public
            Car(String make, String model, int year) &#123; this.make = make;
            this.model = model; this.year = year; &#125; // Method to display
            information about the car public void displayInfo() &#123;
            System.out.println(&quot;Make: &quot; + make);
            System.out.println(&quot;Model: &quot; + model);
            System.out.println(&quot;Year: &quot; + year); &#125; // Method to
            start the car public void start() &#123;
            System.out.println(&quot;The car is starting.&quot;); &#125; &#125;
            // Usage of the &#39;Car&#39; class in another file or the same file
            public class CarExample &#123; public static void main(String[]
            args) &#123; // Create an object of the &#39;Car&#39; class Car
            myCar = new Car(&quot;Toyota&quot;, &quot;Camry&quot;, 2022); //
            Access attributes and call methods using the object
            myCar.displayInfo(); myCar.start(); &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
...
public class CarExample {
    public static void main(String[] args) {
        ...
        <p>
          In Java, an object is an instance of a class. A class is a blueprint
          or template that defines the attributes and behaviors common to all
          objects of that type. Objects are created based on these class
          definitions, and they represent real-world entities or concepts in a
          program.The general syntax for creating an object
        </p>
        <p>
        ...
        {/* <pre>
          <code>
            // Create an object of the &#39;Car&#39; class Car myCar = new
...
Car myCar = new Car("Toyota", "Camry", 2022);`}
        ...
        <p>
          ...
          initialize the state of an object. A constructor is called only when
          the instance of the object is created. Every time in Java object is
          created using the new keyword and by default, the constructor is
          called.
        </p>
        <h4 id="29-what-all-the-rules-must-be-followed-while-creating-a-constructor-in-java">
          29. What all the rules must be followed while creating a constructor
          in Java?
        </h4>
        <p>
          The constructor must have the same name as the class.It cannot have a
          return type, not even &#39;void&#39;. Constructors can take
          parameters, and you can have multiple constructors with different
          parameter lists (overloading). Parameters are used to initialize the
          attributes of the object being created. Constructors can have access
          modifiers like public, private, protected, or package-private
          (default).In Java, a constructor cannot be synchronized, abstract,
          final, and static.
        </p>
        <h4 id="30-what-are-the-different-types-of-constructors-available-in-java">
        ...
        <p>
          ...
          with the default value. Moreover, it is also used to perform some
          useful tasks on object creation.This default constructor is implicitly
          invoked by the compiler if there is no constructor for a particular
          class.
        </p>
        ...
        {/* <pre>
          <code>
            {" "}
            class MyClass&#123; //creating a default constructor MyClass()&#123;
            System.out.println(&quot;Welcome to Java&quot;); &#125; //main
            method public static void main(String args[])&#123; //calling a
            default constructor MyClass c=new MyClass(); &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
    ...
    public static void main(String args[]) {
        ...
        <p>
          <img src={images.myclassoutput} alt="" />
        </p>
        <p>
          <strong>Parameterized constructor: </strong> A parameterized
          constructor is one type of constructor which is mainly used to
          initialize the instance variables with the given values.In simple
          words, the constructor that accepts arguments is called a
          parameterized constructor.
        </p>
        <h6 id="example-24">Example:</h6>
        {/* <pre>
          <code>
            public class Training &#123; int id; String name; //creating a
            parameterized constructor Training(int i,String n)&#123; id = i;
            name = n; &#125; //method to display the values void display()
            &#123; System.out.println(id+&quot; &quot;+name); &#125; public
            static void main(String args[])&#123; //creating objects and passing
            values Training t1 = new Training(111,&quot;DevOps&quot;); //calling
            method to display the values of object t1.display(); &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
          <code>
    ...
    public static void main(String args[]) {
        ...
        <p>
          <img src={images.TrainingOutput} alt="" />
        </p>
        ...
        <p>
          If no constructor is available in the class, the java compiler creates
          a default constructor and assigns the default value to the instance
          variables.
        </p>
        <h6 id="example-25">Example:</h6>
        {/* <pre>
          <code>
            import java.util.*; class A &#123; String name; int id; void
            display() &#123; System.out.println(&quot;Name: &quot;+this.name);
            System.out.println(&quot;Id: &quot;+this.id); &#125; &#125; public
            class B &#123; public static void main(String args[]) &#123; A
            object=new A(); System.out.println(&quot;The values of the instance
            variables are:&quot;); System.out.println(&quot;Name:
            &quot;+object.name); System.out.println(&quot;Name:
            &quot;+object.id); &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
...
public class B {
    public static void main(String args[]) {
        ...
        <p>
          <img src={images.myclassoutput} alt="" className="img-cls" />
        </p>
        ...
        {/* <pre>
          <code>
            public class MyClass &#123; private int myValue; // Instance
            variable public void setMyValue(int myValue) &#123; // Using
            &#39;this&#39; to refer to the instance variable this.myValue =
            myValue; &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    public void setMyValue(int myValue) {
        ...
        <p>
          ...
          create an object to call the non-static main() method, which will
          result in extra memory allocation.
        </p>
        ...
        <h4 id="37-what-is-the-difference-between-multiple-and-multilevel-inheritance">
          37. What is the difference between multiple and multilevel
          inheritance?
        </h4>
        <table>
          <thead>
          ...
          <tbody>
            <tr>
              <td>
                Multiple inheritance comes into picture when a class inherits
            ...
            <tr>
              ...
              <td>
                Example: A class describing a sports car will inherit from a
                base class Car which inturn inherits another class Vehicle
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          ...
          class.Needs careful implementation else would lead to incorrect
          results.
        </p>
        ...
        <p>
          ...
          have a class named Vehicle, it can have a method named speed but you
          cannot define it because different vehicles have different speed.This
          method will be defined in the subclasses with different definitions
        ...
        <h4 id="43-what-is-method-overriding">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                Two or more methods having the same name but different
                parameters or signature
              </td>
              <td>
                Child class redefining methods present in the base class with
        ...
        <p>
          ...
          method) that belongs to the class rather than an instance of the
          class. When a member is declared as static, it means there is only one
          copy of that member shared by all instances of the class, rather than
          each instance having its own copy.
        </p>
        <p>
          ...
          class.It is declared using the static keyword and is typically used
          for constants or properties that should be common to all
          instances.Static variables are accessed using the class name, not
        ...
        <p>
          ...
          methods directly, as they are not associated with a particular
          instance.
        </p>
        <p>
          <strong>Static Block:</strong> A static block is a block of code
          enclosed in curly braces &#123;&#125; that is executed when the class
          is loaded into the Java Virtual Machine (JVM).It is used to initialize
          static variables or perform other static initialization tasks.
        </p>
        <p>
          <strong>Static Nested Classes:</strong> A static nested class is a
          class that is defined within another class and marked as static.It is
          associated with the outer class, not with any specific instance, and
        ...
        {/* <pre>
          <code>
            public class MyClass &#123; static int count; // Static variable //
            Other members... public static void main(String[] args) &#123;
    ...
    public static void main(String[] args) {
        ...
        {/* <pre>
          <code>
            public class MyClass &#123; static &#123; // Static block
    ...
    public static void main(String[] args) {
        ...
        <h6 id="static-nested-classes-example">
          Static Nested Classes Example:
        </h6>
        {/* <pre>
          <code>
            public class OuterClass &#123; static class StaticNestedClass &#123;
            // Static nested class &#125; &#125;
          </code>
        </pre> */}
        <pre className="code-block">
    ...
    static class StaticNestedClass {
        ...
        <p>
          ...
          specifiers allow the implementation of encapsulation. The most common
          access specifiers are public, private and protected. However, there
          are a few more which are specific to the programming languages.
        </p>
        <h4 id="48-what-is-the-difference-between-public-private-and-protected-access-modifiers">
          48. What is the difference between public, private and protected
          access modifiers?
        </h4>
        <table className="table">
          <thead>
        ...
        <p>
          ...
          implementation details.For example, while riding a bike, you know that
          if you raise the accelerator, the speed will increase, but you don’t
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Binds code and data together into a single unit and hides it
                from the world
              </td>
            </tr>
          </tbody>
