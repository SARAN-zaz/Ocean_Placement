  ...
  return (
    <section className=" bg-[#F6F9FA]">
      <section className=" max-w-[1200px] mx-auto w-[80%]">
        <div className="py-10">
          <h1 className="text-[#0E90CF] text-[30px] font-semibold text-center">
            Placed Students
          </h1>

          {/* Card 1 */}
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mt-5">
            <div className="bg-[#D9F1FF] rounded-2xl shadow-lg w-full sm:w-[300px] md:w-[400px] lg:w-[450px] p-6  border-l-[12px] border-[#0E90CF]">
